...
EQ_mode = 1; % packet-based-LS = 0, adaptive LS = 1, 
...
[recived_ofdm] = ofdm_demod(EQ_mode, signal_over_channel,P, L, series_msg_length, mask, zeros_to_append,M, imageSize, bitsPerPixel, colorMap, trainingblock, TB_size, data_size);
